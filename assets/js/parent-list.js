      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<a href="mailto:'+$mail+'" class="fw-medium">'+$mail+'</a>'
          }
        },
        {
          // Plans
          ...
          render: function (data, type, full, meta) {
            ...
            return '<a  href="tel:'+$phone+'" class="fw-medium">' + $phone + '</a>';
          }
        },
        {
          targets: 4,
          render: function (data, type, full, meta) {
            ...
            for (let i = 0; i < students.length; i++) {
              row += '<a href="#" class="badge bg-label-success text-capitalize">' + students[i] + '</a> ';
            }
